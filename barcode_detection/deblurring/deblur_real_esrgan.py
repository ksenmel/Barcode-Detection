...
class DeblurRealEsrgan(Deblurrer):
    def deblur(
        ...
        os.system(f'ffmpeg -i {video_name} -qscale:v 1 -qmin 1 -qmax 1 -vsync 0 tmp_frames/frame%08d.jpg')
        os.system('./realesrgan-ncnn-vulkan -i tmp_frames -o out_frames -n realesr-animevideov3 -s 2 -f jpg')
